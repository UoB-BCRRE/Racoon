...
./stardog namespace add --prefix wgs --uri http://www.w3.org/2003/01/geo/wgs84_pos# $db
...
./stardog namespace add --prefix py --uri http://purl.org/rail/py/ $db
./stardog namespace add --prefix geof --uri http://www.opengis.net/def/function/geosparql/ $db
./stardog namespace add --prefix geo --uri http://www.opengis.net/ont/geosparql# $db
./stardog namespace add --prefix dc --uri http://purl.org/dc/elements/1.1/ $db
